...
# 1.确定原图像数据集路径
data_root = 'E:\\SC\\vscode\\Rock identification\\rock_data'
# 2.确定数据集划分后保存的路径
split_dir = 'E:\\SC\\vscode\\Rock identification\\rock_data'
train_dir = 'E:\\SC\\vscode\\Rock identification\\train'
valid_dir = 'E:\\SC\\vscode\\Rock identification\\val'
test_dir = 'E:\\SC\\vscode\\Rock identification\\test'
...
for root, dirs, files in os.walk(data_root):
    for sub_dir in dirs: # 遍历0，1，2，3，4，5...9文件夹
        ...
        for i in range(img_count):
            ...
            src_path = os.path.join(data_root, sub_dir, imgs[i])  #指定目标原图像路径
